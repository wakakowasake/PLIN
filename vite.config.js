    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                nowDoPrivacy: resolve(__dirname, 'public/nowdo/privacy.html'),
                nowDoSupport: resolve(__dirname, 'public/nowdo/support.html'),
                ourRulesLanding: resolve(__dirname, 'public/our-rules/index.html'),
                ourRulesPrivacy: resolve(__dirname, 'public/our-rules/privacy.html'),
                ourRulesTerms: resolve(__dirname, 'public/our-rules/terms.html'),
                ourRulesSupport: resolve(__dirname, 'public/our-rules/support.html'),
                ourRulesJoin: resolve(__dirname, 'public/our-rules/join.html'),
