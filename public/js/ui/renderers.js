...
function buildTransitCard(item, index, dayIndex, editClass) {
    ...
    return `
            <div class="bg-blue-50/50 dark:bg-card-dark/40 border border-blue-100 dark:border-gray-800 rounded-lg p-3 flex flex-col gap-2 ${editClass}" onclick="if(window.openTransitDetailModal){const item=window.travelData.days[${dayIndex}].timeline[${index}];window.openTransitDetailModal(item,${index},${dayIndex});}">
